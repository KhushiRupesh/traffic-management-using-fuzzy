...
density_system = ctrl.ControlSystem(
    [density_rule1, density_rule2, density_rule3, density_rule4]
)
...
extRule4 = ctrl.Rule(
    dense_val1["very_low"] | dense_val2["very_high"], extension["larger"]
)
...
extRule13 = ctrl.Rule(
    dense_val1["very_high"] | dense_val2["very_low"], extension["larger"]
)
...
extRule16 = ctrl.Rule(
    dense_val1["very_high"] | dense_val2["very_high"], extension["zero"]
)

extension_system = ctrl.ControlSystem(
    [
        extRule1,
        extRule2,
        extRule3,
